...
int main()
{
    //ptr=puntero a entero para manejar memoria dinamica
    //i=variable de control para los bucles for
    //n1=tamaño inicial del bloque de memoria
    //n2=tamaño nuevo al que se reajustara el bloque
    int *ptr, i, n1, n2;
    ...
    for (i=0; i<n1; i++) //imprime la direccion de cada entero reservado
        printf("\n\np = %p\n", ptr+i); 
    ...
    for (i=0; i<n2; i++) // imprime la direccion de cada entero en el nuevo tamanio
        printf("\n\np = %p\n", ptr+i);
